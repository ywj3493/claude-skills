...
- **Test Design**: Write integration tests based on sequence diagrams
...
- [API Specification](../requirements/api-spec.md) - API endpoint specifications
...
**API Endpoint**: [METHOD /api/path](../requirements/api-spec.md#method-apipath)
...
**API Endpoint**: <!-- Endpoint reference -->
...
- [Requirements Analysis](../requirements/requirements.md) - Requirements traceability
- [User Stories](../requirements/user-stories.md) - User stories by role
- [API Specification](../requirements/api-spec.md) - API endpoints
- [Use Case Specification](use-cases.md) - Use case details
- [Architecture](../../architecture.md) - Architecture explanation

### Code References

- <!-- [controller.py](path) - HTTP controller -->
- <!-- [use_case.py](path) - Business use case -->
- <!-- [service.py](path) - Application service -->
- <!-- [repository.py](path) - Data access -->
- <!-- [client.py](path) - External service adapter -->
- <!-- [entity.py](path) - Domain model -->
